...
> **REGLA CRÍTICA: TODOS LOS MODALES DEBEN SER SIDE MODALS (Sheet)**
>
> En TODA la aplicación, cualquier modal para crear, editar, ver detalle o cualquier acción que requiera
> un formulario o mostrar información adicional DEBE usar el componente `Sheet` (side modal que aparece
> desde el costado derecho). NUNCA usar modales centrados (`Dialog`) para estas operaciones.
>
> Esto aplica a:
...
>
> Solo usar `Dialog` centrado para:
> - Confirmaciones simples de eliminación (Sí/No)
> - Alertas críticas
>
> **Componente a usar:** `frontend/src/components/ui/Sheet.tsx`

| Elemento | Implementación | ❌ NO hacer |
|----------|----------------|-------------|
| **Listado** | Página completa con tabla | Página vacía que solo lista IDs |
| **Crear nuevo** | Side modal (Sheet) | Página `/cuadrillas/nuevo` o Dialog centrado |
| **Editar** | Side modal (Sheet) | Página `/cuadrillas/:id/editar` o Dialog centrado |
| **Ver detalle** | Side modal (Sheet) | Página separada o Dialog centrado |
| **Eliminar** | Dialog de confirmación simple | Eliminar sin confirmar |
